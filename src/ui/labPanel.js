...
export function createLabPanel({ params, moments, onReset, onMoment, onModeChange, onPauseChange }) {
  ...
  const liveParams = [
    ...
    ['magnetar', 'Bucles de magnetar', 0, 2.5, 0.01],
    ['magnetarRatio', 'Fracción en bucles', 0, 1, 0.01],
    ['magnetarRadius', 'Radio de los bucles', 0.5, 5, 0.1],
    ['magnetarSpeed', 'Velocidad de los bucles', 0, 4, 0.05],
    ['magnetarLoops', 'Número de bucles', 1, 16, 1],
    ['curve', 'Curva de infinito (banco)', 0, 2.5, 0.01],
    ['curveScale', 'Tamaño de la curva', 0.5, 6, 0.1],
    ['curveSpeed', 'Velocidad en la curva', 0, 4, 0.05],
